...
class OrdenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordene" do
    assert_difference('Ordene.count') do
      post ordenes_url, params: { ordene: { cliente_id: @ordene.cliente_id, fecha: @ordene.fecha, numero_de_orden: @ordene.numero_de_orden } }
    end
  ...
  test "should update ordene" do
    patch ordene_url(@ordene), params: { ordene: { cliente_id: @ordene.cliente_id, fecha: @ordene.fecha, numero_de_orden: @ordene.numero_de_orden } }
